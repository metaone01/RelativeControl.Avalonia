...
public readonly struct RelativeThickness : IEquatable<RelativeThickness> {
    ...
    public Thickness Absolute() => new(Left.ActualPixels, Top.ActualPixels, Right.ActualPixels, Bottom.ActualPixels);
    ...
    /// </returns>
    public override bool Equals(object? obj) => obj is RelativeThickness other && Equals(other);
